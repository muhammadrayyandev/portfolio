...
const AnimatedBackground = () => {
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-1/3 w-20 h-20 bg-[#0EA5E9] rounded-full opacity-15 blur-2xl animate-bounce" style={{ animationDuration: '4s' }} />
    </div>
  );
};
...
const Contact = () => {
  return (
    <section className="relative py-20 px-6 bg-black text-white overflow-hidden" id='contact'>
      <AnimatedBackground />
      <style jsx>{`
        @keyframes float {
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white font-semibold">tayyabktk2002@gmail.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <span className="text-2xl">📱</span>
                <span className="text-white font-semibold">+92 349 5336214</span>
              </div>
              <div className="flex items-center space-x-3">
                <span className="text-2xl">📍</span>
          ...
          <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10">
            <form className="space-y-6" action="https://formsubmit.co/tayyabktk2002@gmail.com" method="POST">
              <div>
