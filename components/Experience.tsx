    ...
    <section className="py-20 px-6 bg-black text-white" id="experiences">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h2
            data-aos="fade-down"
            className="text-4xl font-bold mb-4 tracking-tight uppercase"
          >
          ...
          <div className="space-y-12">
            {experiences.map((exp, index) => (
              ...
              >
                ...
                {/* Content */}
                <div
                  className={`w-5/12 bg-gray-900 p-6 rounded-lg border border-gray-800 hover:border-[#0EA5E9]/30 transition-colors ${
